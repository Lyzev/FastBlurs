...
PFNGLGETFIRSTPERFQUERYINTELPROC glGetFirstPerfQueryIdINTEL    = nullptr;
PFNGLGETNEXTPERFQUERYINTELPROC glGetNextPerfQueryIdINTEL    = nullptr;
...
PFNGLDELETEPERFQUERYPROC  glDeletePerfQueryINTEL    = nullptr;
...
bool g_CPUT_GL_IS_AMD_VENDOR = false;
...
CPUTResult CPUT_OGL::CreateOGLContext(CPUTContextCreation ContextParams )
{
    ...
    g_CPUT_GL_IS_AMD_VENDOR = false;
    if( (vendorName == "ATI Technologies Inc.") || supportExtension("GL_AMD_debug_output") || supportExtension(" AMD_gcn_shader") )
        g_CPUT_GL_IS_AMD_VENDOR = true;
    ...
    g_CPUT_GL_EGL_COMPUTE_SHADER_SUPPORTED = supportExtension( "GL_ARB_compute_shader" );
	...
	{
		glDeletePerfQueryINTEL = (PFNGLDELETEPERFQUERYPROC)wglGetProcAddress("glDeletePerfQueryINTEL");
		glCreatePerfQueryINTEL = (PFNGLCREATEPERFQUERYINTELPROC)wglGetProcAddress("glCreatePerfQueryINTEL");
		glGetFirstPerfQueryIdINTEL = (PFNGLGETFIRSTPERFQUERYINTELPROC)wglGetProcAddress("glGetFirstPerfQueryIdINTEL");
		glGetNextPerfQueryIdINTEL = (PFNGLGETNEXTPERFQUERYINTELPROC)wglGetProcAddress("glGetNextPerfQueryIdINTEL");
	...
	{
		glQueryCounter =  (PFNGLQUERYCOUNTERPROC)wglGetProcAddress("glQueryCounterINTEL");
		glGetQueryObjectiv =  (PFNGLGETQUERYOBJECTIVPROC)wglGetProcAddress("glGetQueryObjectivINTEL");
		glGetQueryObjectui64v =  (PFNGLGETQUERYOBJECTUI64VPROC)wglGetProcAddress("glGetQueryObjectui64vINTEL");
	}
