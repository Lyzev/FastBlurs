...
CPUTResult CPUTFileSystem::OpenWriteFile(const std::string &fileName, FILE **ppFilePointer)
{
    errno_t err = fopen_s(ppFilePointer, fileName.c_str(), "w+");
...
CPUTResult CPUTFileSystem::TranslateFileError(errno_t err)
{
    ...
    case 22: result = CPUT_ERROR_FILE_NOT_FOUND; break;
    default:
